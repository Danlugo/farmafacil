...
| `tests/` | pytest test suite (317 tests) |
...
| Table | Purpose |
|-------|---------|
| `users` | Phone, name, location, display preference, response mode override, chat debug override, last search log ID, cumulative token counters, onboarding step |
