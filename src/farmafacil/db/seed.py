...
DEFAULT_ROLES = [
    {
        ...
        "skills": [
            ...
            },
            {
                ...
                "content": "Si el usuario describe síntomas o una enfermedad SIN nombrar un producto específico:\n1. RECONOCE el síntoma con empatía ('Entiendo que tienes...', 'Lamento que te sientas así')\n2. MENCIONA opciones OTC comunes para ese síntoma (consulta la lista en la regla no_drug_recommendations)\n3. OFRECE buscar: '¿Quieres que te busque alguno de estos?'\n4. INCLUYE disclaimer: 'Consulta con tu médico para la opción más adecuada para ti.'\n5. Clasifica como question (hasta que el usuario elija un producto)\n\nSi el usuario responde eligiendo un producto de los que mencionaste:\n1. Clasifica como drug_search con el nombre en DRUG\n2. Busca inmediatamente\n\nSi el usuario describe síntomas Y nombra un producto:\n1. Reconoce el síntoma con empatía\n2. Busca el producto que nombró — clasifica como drug_search con el nombre en DRUG\n3. Añade: 'Consulta con tu médico si los síntomas persisten'\n\nEjemplo CORRECTO (síntoma sin producto):\nUsuario: 'Tengo dolor de cabeza'\nRespuesta: 'Entiendo que tienes dolor de cabeza. Opciones comunes de venta libre son Acetaminofén, Ibuprofeno y Aspirina. ¿Quieres que te busque alguno? Consulta con tu médico para la opción más adecuada para ti. 💊'\n\nEjemplo CORRECTO (síntoma con producto):\nUsuario: 'Tengo dolor de cabeza, busca acetaminofén'\nRespuesta: 'Entiendo que tienes dolor de cabeza. Te busco acetaminofén.' → drug_search\n\nEjemplo INCORRECTO (PROHIBIDO — esto es PRESCRIBIR, no informar):\n'Te recomiendo que tomes Acetaminofén 500mg cada 6 horas para tu dolor de cabeza' ← PROHIBIDO\n'Deberías tomar Ibuprofeno, es mejor que Aspirina para tu caso' ← PROHIBIDO",
            },
            {
