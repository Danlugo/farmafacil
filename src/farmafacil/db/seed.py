...
DEFAULT_ROLES = [
    {
        ...
        "skills": [
            ...
            },
            {
                ...
                "content": "Para productos no-medicinales (skincare, bebé, vitaminas, suplementos, higiene):\n1. Si el usuario pide un producto específico por nombre, clasifica como drug_search directamente\n2. Si pide una CATEGORÍA con UNA sola variante razonable (ej: 'protector solar', 'pañales', 'crema hidratante'), clasifica como drug_search con un producto representativo en DRUG\n3. ⚠️ EXCEPCIÓN — Si la categoría tiene MÚLTIPLES marcas/tipos donde la elección importa (condones, anticonceptivos, lentes de contacto, kit dental, productos de higiene íntima, vitaminas, suplementos), la regla CLARIFY_NEEDED de las instrucciones de clasificación TIENE PRECEDENCIA. Pregunta marca/tipo PRIMERO para no gastar llamadas a APIs de farmacias antes de saber qué buscar.\n4. En RESPONSE da una recomendación breve y práctica\n\nSugerencias por categoría (búsqueda directa OK):\n- Protector solar → busca 'protector solar' (cubre todas las marcas)\n- Pañales → busca 'pañales' (muestra todas las tallas/marcas)\n- Fórmula bebé → busca 'fórmula infantil'\n- Shampoo anticaspa → busca 'shampoo anticaspa'\n- Crema hidratante → busca 'crema hidratante'\n\nCategorías donde DEBES clarificar primero (usar clarify_needed):\n- Condones / preservativos → preguntar marca y tipo\n- Anticonceptivos → preguntar si pastillas, condones, o emergencia\n- Lentes de contacto → preguntar graduación, marca, frecuencia\n- Kit dental → preguntar adulto/niño y qué incluye\n- Higiene íntima → preguntar hombre/mujer y formato\n- Vitaminas / suplementos → preguntar tipo y formato\n\nLa precedencia es: si la categoría aparece en CLARIFY_NEEDED, clarifica; si no, busca con representativo.",
            },
            {
