...
HELP_MESSAGE = (
    ...
    "medicamentos, vitaminas, skincare, cuidado personal, y m\u00e1s.\n\n"
    "*Buscar producto:*\n"
    "\u2022 Env\u00eda el nombre (ej: _losartan_, _protector solar_)\n"
    "\u2022 O describe lo que necesitas (ej: _algo para el dolor de cabeza_)\n"
    "\u2022 Escribe _mejor precio de losartan_ para la opci\u00f3n m\u00e1s econ\u00f3mica\n\n"
    "*M\u00e1s formas de buscar:*\n"
    "\U0001f3a4 Env\u00eda una nota de voz con lo que necesitas\n"
    "\U0001f4f7 Env\u00eda una foto de una receta o producto\n"
    "\U0001f4cd Comparte tu ubicaci\u00f3n GPS para buscar cerca de ti\n\n"
    "*Farmacias cercanas:*\n"
    "\u2022 Pregunta _farmacia cercana_ o _d\u00f3nde comprar_\n\n"
    "*Configuraci\u00f3n:*\n"
    "\u2022 _cambiar zona_ \u2014 nueva ubicaci\u00f3n\n"
    "\u2022 _cambiar nombre_ \u2014 actualizar tu nombre\n\n"
    "*Comandos:*\n"
    "\u2022 _ver similares_ \u2014 m\u00e1s resultados tras una b\u00fasqueda\n"
    "\u2022 _/sugerencia <texto>_ \u2014 enviar una sugerencia\n"
    "\u2022 _/bug <texto>_ \u2014 reportar un problema\n\n"
    "*Ejemplos:*\n"
    "\u2022 _losartan_\n"
    "\u2022 _acetaminof\u00e9n 500mg_\n"
    "\u2022 _protector solar_\n"
