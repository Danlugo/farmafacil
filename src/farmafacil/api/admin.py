...
class UserSuggestionAdmin(ModelView, model=UserSuggestion):
    """Admin view for /sugerencia submissions."""
    ...
    column_searchable_list = [UserSuggestion.message, UserSuggestion.phone_number]
    column_sortable_list = [
        UserSuggestion.id,
        UserSuggestion.user_id,
        UserSuggestion.reviewed,
